...
東大の進学振り分けにおいてコンピュータ・サイエンスとデータサイエンスは超人気になっています。高い成績を取っていないと希望する学科に進学することは難しいでしょう。
コンピュータ・サイエンスを学びたいと決めている高校生は、もしかしたら他大学のコンピュータ・サイエンス専攻に進学したほうが良いのかもしれません。
データサイエンスを学びたいと決めている高校生は、いろいろな学科がデータサイエンスを研究に取り入れているため、東京大学に進学しても問題ないと考えています。

google, amazon,　大手IT企業のSWE職（ソフトウェアエンジニアリング職）に就きたいと考えている学生は、コンピュータ・サイエンスを学んだほうが良いでしょう。他には、データ構造とアルゴリズムなどのコーディング面接対策が重要です。
データサイエンスのフレームワークの開発には、コンピュータ・サイエンスのバックグラウンドが求められています。コンピュータ・サイエンスを学んだあとでデータサイエンスのフレームワークの開発をするエンジニアになることは容易ですが、逆は難しいでしょう。
