...
HTTP リクエストのこのような区分を、<Term type="httpMethod">**メソッド**</Term>と呼びます。
...
<p>
  <Term type="queryString">クエリパラメータ</Term>にアクセスするには、
  <code>request.query</code> (<a href="https://expressjs.com/ja/api.html#req.query">
    <code>express.Request#query</code> プロパティ
  </a>) を使用しましたが、<Term type="httpHeaderBody">リクエストボディ</Term>
  を使用するには、<code>request.body</code> (
  <a href="https://expressjs.com/ja/api.html#req.body">
    <code>express.Request#body</code> プロパティ
  </a>
  ) を使用します。
</p>
