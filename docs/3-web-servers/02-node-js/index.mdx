...
**ターミナル** は、文字を用いてコンピューターと会話するためのソフトウェアです。 だと標準搭載の `ターミナル` が、Windows だと [`Windows Terminal` アプリ](https://apps.microsoft.com/store/detail/windows-terminal/9N0DX20HK701)が利用できますが、VS Code 内蔵のターミナルもなかなか便利です。
