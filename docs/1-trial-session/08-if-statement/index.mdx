...
import theRightToVoteHtml from "./_samples/the-right-to-vote/index.html?raw";
import theRightToVoteJs from "./_samples/the-right-to-vote/script.js?raw";
...
- 18歳未満なら`選挙権はありません`と表示する
- 18歳以上～25歳未満なら`投票に行けます`と表示する
- 25歳以上なら`衆議院議員に立候補できます`と表示する
