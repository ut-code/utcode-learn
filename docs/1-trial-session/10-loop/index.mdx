...
import answerForHtml from "./_samples/answer-for/index.html?raw";
import answerForJs from "./_samples/answer-for/script.js?raw";
import productHtml from "./_samples/product/index.html?raw";
import productJs from "./_samples/product/script.js?raw";
import productAltHtml from "./_samples/product-alt/index.html?raw";
import productAltJs from "./_samples/product-alt/script.js?raw";
import isPrimeHtml from "./_samples/is-prime/index.html?raw";
import isPrimeJs from "./_samples/is-prime/script.js?raw";
...
<Sandpack
  template="static"
  files={{
    "/index.html": answerForHtml,
    "/script.js": answerForJs,
  }}
  options={{
...
<Sandpack
  template="static"
  files={{
    "/index.html": productAltHtml,
    "/script.js": productAltJs,
  }}
  options={{
    activeFile: "/script.js",
  }}
