...
document.write(
  `<p>配列 [${array1}] の最大値は${numbersMax(array1)} です。</p>`,
);
document.write(
  `<p>配列 [${array2}] の最大値は${numbersMax(array2)} です。</p/>`,
);
document.write(
  `<p>配列 [${array3}] の最大値は${numbersMax(array3)} です。</p>`,
);
document.write(
  `<p>配列 [${array4}] の最大値は${numbersMax(array4)} です。</p>`,
);
document.write(`<p>空の配列の最大値は ${numbersMax([])} です。</p/>`);
