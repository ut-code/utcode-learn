...
import arrayHtml from "./_samples/array/index.html?raw";
import arrayJs from "./_samples/array/script.js?raw";
import arraySumForOfHtml from "./_samples/array-sum-for-of/index.html?raw";
import arraySumForOfJs from "./_samples/array-sum-for-of/script.js?raw";
import arraySumSimpleForHtml from "./_samples/array-sum-simple-for/index.html?raw";
import arraySumSimpleForJs from "./_samples/array-sum-simple-for/script.js?raw";
import arrayMaxHtml from "./_samples/array-max/index.html?raw";
import arrayMaxJs from "./_samples/array-max/script.js?raw";
...
<Sandpack
  template="static"
  files={{
    "/index.html": arraySumForOfHtml,
    "/script.js": arraySumForOfJs,
  }}
  options={{
    activeFile: "/script.js",
  }}
...
<Sandpack
  template="static"
  files={{
    "/index.html": arraySumSimpleForHtml,
    "/script.js": arraySumSimpleForJs,
  }}
  options={{
    activeFile: "/script.js",
  }}
...
<Sandpack
  template="static"
  files={{
    "/index.html": arrayMaxHtml,
    "/script.js": arrayMaxJs,
  }}
  options={{
    activeFile: "/script.js",
  }}
