...
import maxNoElseHtml from "!!raw-loader!./_samples/max-no-else/index.html";
import maxNoElseJs from "!!raw-loader!./_samples/max-no-else/script.js";
...
<Sandpack
  template="static"
  files={{
    "/index.html": maxNoElseHtml,
    "/script.js": maxNoElseJs,
  }}
  options={{
    activeFile: "/script.js",
  }}
