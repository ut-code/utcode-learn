...
次の行 `return sum` で `add` <Term type="javascriptFunction">関数</Term>は <Term type="javascriptVariable">変数</Term> `sum` を<Term type="javascriptEvaluate">評価</Term>し、`7` を<Term type="javascriptReturn">返します。</Term>
