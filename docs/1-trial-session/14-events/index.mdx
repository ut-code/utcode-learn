...
import projectJackInABoxHtml from "./_samples/project-jack-in-a-box/index.html?raw";
import projectJackInABoxJs from "./_samples/project-jack-in-a-box/script.js?raw";
