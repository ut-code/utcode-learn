...
HTML の要素はすべて、一定の高さと幅を持った四角形だと考えることができます。
その四角形は
...
![span 要素を 3 つ並べる](./three-span.png)
...
![display: flex を指定すると横並びになる](./flex.png)
...
![position: relative による調整](./position-relative.png)
...
![position: absolute による調整](./position-absolute.png)
